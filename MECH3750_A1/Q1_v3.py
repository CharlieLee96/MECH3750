...
##            print(j)
#            if j == var[0]:
#                i2=i.subs({'t':j2,'u':u1,'v':v1,'w':w1})
##                print(i2)
#                i3=(i2-i.subs({'t':t1,'u':u1,'v':v1,'w':w1}))/dx
##                print(i2)
#            elif j == var[1]:
#                i2=i.subs({'t':t1,'u':j2,'v':v1,'w':w1})
#                i3=(i2-i.subs({'t':t1,'u':u1,'v':v1,'w':w1}))/dx
##                print(i2)
#            elif j == var[2]:
#                i2=i.subs({'t':t1,'u':u1,'v':j2,'w':w1})
#                i3=(i2-i.subs({'t':t1,'u':u1,'v':v1,'w':w1}))/dx
##                print(i2)
#            elif j == var[3]:
#                i2=i.subs({'t':t1,'u':u1,'v':v1,'w':j2})
#                i3=(i2-i.subs({'t':t1,'u':u1,'v':v1,'w':w1}))/dx
##                print(i2)
#            Jc0.append(i2)
#    Jc=np.asarray(Jc0)
#    Jc=np.array_split(Jc,4)
##    jc=list(Jc)
#    print(Jc)
#    return Jc
#var1=['t','u','v','w']
#forward_diff(f,var1,str(0.02))
b={'t':1,'u':1,'v':1,'w':1}
